...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribeOnMessageReceived = chatRoom.addListener(
      ...
      (message) => {
        ...
        var messageType = message.attributes && message.attributes.message_type || 'MESSAGE';
        switch (messageType) {
          case 'RAISE_HAND':
  ...
  const handleSticker = (data) => {
    //const username = data.sender.attributes?.username;
    var username = data.sender.attributes && data.sender.attributes.username;
    const userId = data.sender.userId;
    const avatar = data.sender.attributes.avatar;
    const message = data.content;
  ...
  const handleRaiseHand = async (data) => {
    //const username = data.sender.attributes?.username;
    const username = data.sender.attributes && data.sender.attributes.username;
